<a href="#search-box" class="search-toggle" data-toggle=".menu-container__search-box">
    ...
    <form id="search" method="GET" action="https://khaledalsabt.com/search?">
        ...
        <div class="input-group input-group--header utility__bg--white">
            ...
            <SearchBox
                ...
                data-value='' data-item-class='autocomplete-item' data-highlight-class='autocomplete-item-highlighted'
                data-menu-class='autocomplete-menu' data-wrapper-props='{"className": "searchBox-wrapper"}'
